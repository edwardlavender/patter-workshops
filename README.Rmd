...
1.  **`doc/`** contains workshop documentation:
    ...
    - `patter-v.1.0-1/patter-intro.html` is an introductory presentation for `patter v.1.0-1`
    - **`patter-v.2.0-0/patter-intro.html` is an introductory presentation for `patter v.2.0-0`**
