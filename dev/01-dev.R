...
# Geospatial packages
# * terra and sf need to be downloaded from CRAN
# * There is an issue with the POSIT versions
# * This causes terra::cellSize(patter::dat_gebco()) to fail
# * See: https://github.com/r-spatial/sf/issues/2353
renv::install("terra", repos = "https://cran.r-project.org", rebuild = TRUE)
renv::install("sf", repos = "https://cran.r-project.org", rebuild = TRUE)
# Register pbapply for patter::pf_plot_xy()
renv::install("pbapply", prompt = FALSE)
...
dv::use_template_readme(title = "`patter` workshops",
...
dv::use_template_script(dv::here_r("patter-intro.R"))
