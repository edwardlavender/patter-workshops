...
![Inference using particle algorithms.](../../fig/ssm-inference.png)

## Methodology

![Particle filter intuition.](../../fig/particle-filter.png)
...
![The two filter smoother.](../../fig/particle-smoother.png)
...
![`patter` workflow](../../fig/patter-workflow.png)
...
-   For custom `State` and `ModelMove` structures, we need to:
    ...
    2.  (optional) Write `states_init()` methods to translate initial coordinates to `State`s
